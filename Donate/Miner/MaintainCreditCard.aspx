<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MaintainCreditCard.aspx.cs" Inherits="Donate.MaintainDonateSiteData" %>
    ...
    <div id="div1">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" Theme="Office2003Olive" KeyFieldName="DonorID">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="PhoneNumber" Caption ="電話號碼" ReadOnly="True" VisibleIndex="2">
                </dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="CardNumber" Caption="卡號" ReadOnly="True" VisibleIndex="5">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Sponsor" Caption="捐款方式" ReadOnly="True" VisibleIndex="6">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="ContributionWay" Caption="具/匿" ReadOnly="True" VisibleIndex="7">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Email2" Caption="電郵" ReadOnly="True" VisibleIndex="8">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="DonateTime" Caption="捐款時間" ReadOnly="True" VisibleIndex="9">
                </dx:GridViewDataDateColumn>
            </Columns>
        </dx:ASPxGridView>
    </div>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\v11.0;AttachDbFilename=|DataDirectory|\Donate.mdf;Integrated Security=True;MultipleActiveResultSets=True;Application Name=候選人捐款網站" ProviderName="System.Data.SqlClient" SelectCommand="select  a.Amount,'' as DonorName, '' as PhoneNumber, a.ComesFrom as Address , '' as DonorID, c.CardNumber, a.Sponsor,a.ContributionWay,a.Email2,A.DonateTime from AnonymousDonate  a inner join CardInfo c on a.DonateID=c.DonateID
union all
